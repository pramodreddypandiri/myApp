    ...
    <>
       <div className='m-10 p-5'>
        <div className='flex flex-col gap-5'> 
          ...
          <div className='flex lg:flex-col justify-between flex-row gap-5 '>
              ...
              <NavLink to='/manage/settings/myprofile' className='bg-black uppercase text-center rounded-lg text-white  py-2 px-4'>
                My Profile
              </NavLink>
